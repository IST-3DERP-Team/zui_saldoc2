		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Sales Document",
									"targetURL": "#zuisaldoc2zuisaldoc2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuisaldoc2zuisaldoc2-display": {
								"semanticObject": "zuisaldoc2zuisaldoc2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuisaldoc2.zuisaldoc2",
									"url": sap.ui.require.toUrl("zuisaldoc2/zuisaldoc2")
								}
							}
						}
					}
