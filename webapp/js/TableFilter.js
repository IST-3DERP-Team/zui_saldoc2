sap.ui.define([ 
	...
	return {        
        ...
        onColFilter: function(oEvent, sColumnLabel, oThis) {
            ...
            var sDialogFragmentName = "zuisaldoc2.zuisaldoc2.view.fragments.dialog.GenericFilterDialog";
            ...
            if (oFilter !== "") {
                if (sSourceTabId === "salDocDynTable") {
                    if (me.byId(sSourceTabId).getBinding("rows").aIndices.length === 0) {
                        me.getView().getModel("ui").setProperty("/activeSaldocNo", '');
                        me.getView().getModel("ui").setProperty("/saldocCount", 0);
                ...
                me.getView().getModel("ui").setProperty("/saldocCount", me.byId(sSourceTabId).getModel().getData().rows.length);
            }
        },
                ...
                if (oDialog) {
                    ...
                    if (sTableId === "salDocDynTable") {
                        if (me.byId(sTableId).getBinding("rows").aIndices.length === 0) {
                            ...
                            me.getView().getModel("ui").setProperty("/saldocCount", me.byId(sTableId).getBinding("rows").aIndices.length);
                        }
                    }
                    else {
                        var vCount = "";

                        if (sTableId === "salDocDynTable") { vCount = "/saldocCount" }
